export default function PRListSkeleton() {
  return (
    <div className={'max-w-pr-item border-dark-grey-100 flex flex-1 border-e-1 py-4 pe-6'}>
      <div className={'w-full animate-pulse space-y-4'}>
        {Array.from({ length: 5 }).map((_, index) => (
          <div key={index} className={`bg-dark-grey-50 flex w-full flex-col gap-5 rounded-xl px-2.5 py-4`}>
